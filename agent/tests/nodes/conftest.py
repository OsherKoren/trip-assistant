...
def mock_specialist_llm(mocker):
    ...
    def _mock(answer: str):
        # Patch specialist_factory module (used by all factory-generated specialists)
        mock = mocker.patch("src.nodes.specialist_factory.ChatOpenAI")
        mock.return_value.invoke.return_value.content = answer

        # Patch general specialist (not generated by factory)
        general_mock = mocker.patch("src.nodes.general.ChatOpenAI")
        general_mock.return_value.invoke.return_value.content = answer
